...
<div class="page-header">
    <div class="d-flex justify-content-between align-items-center">
        ...
        <a href="<?= base_url('inventory/purchase-orders') ?>" class="btn btn-outline-dark">
...
<div class="card">
    <div class="card-body">
        <form action="<?= base_url('inventory/purchase-orders/create') ?>" method="POST" id="poForm">
            <?php echo csrf_field(); ?>
            ...
            <div class="d-flex justify-content-end gap-2">
                <a href="<?= base_url('inventory/purchase-orders') ?>" class="btn btn-outline-dark">Cancel</a>
