...
class Module_label_model {
    ...
    private function getDefaultLabels() {
        return [
            'dashboard' => ['module_code' => 'dashboard', 'display_label' => 'Dashboard', 'icon_class' => 'icon-home'],
            'accounting' => ['module_code' => 'accounting', 'display_label' => 'Accounting', 'icon_class' => 'icon-calculator'],
            'bookings' => ['module_code' => 'bookings', 'display_label' => 'Bookings', 'icon_class' => 'icon-calendar'],
            'properties' => ['module_code' => 'properties', 'display_label' => 'Properties', 'icon_class' => 'icon-building'],
            'inventory' => ['module_code' => 'inventory', 'display_label' => 'Inventory', 'icon_class' => 'icon-package'],
            'utilities' => ['module_code' => 'utilities', 'display_label' => 'Utilities', 'icon_class' => 'icon-zap'],
            'reports' => ['module_code' => 'reports', 'display_label' => 'Reports', 'icon_class' => 'icon-bar-chart'],
            'settings' => ['module_code' => 'settings', 'display_label' => 'Settings', 'icon_class' => 'icon-settings'],
            'users' => ['module_code' => 'users', 'display_label' => 'User Management', 'icon_class' => 'icon-users'],
            'notifications' => ['module_code' => 'notifications', 'display_label' => 'Notifications', 'icon_class' => 'icon-bell']
        ];
    }
