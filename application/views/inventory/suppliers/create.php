...
<div class="page-header">
    <div class="d-flex justify-content-between align-items-center">
        <h1 class="page-title mb-0">Add Supplier</h1>
        <a href="<?= base_url('inventory/suppliers') ?>" class="btn btn-primary">
...
<div class="card">
    <div class="card-body">
        <form method="POST" action="<?= base_url('inventory/suppliers/create') ?>">
            <?php echo csrf_field(); ?>
            ...
            <div class="d-flex justify-content-between">
                <a href="<?= base_url('inventory/suppliers') ?>" class="btn btn-primary">Cancel</a>
