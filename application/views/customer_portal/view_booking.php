                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="alert alert-warning py-2 mt-3 mb-0" style="font-size: 0.85rem;">
                            <i class="bi bi-exclamation-triangle"></i> <strong>Cancellation Policy:</strong> <?= htmlspecialchars(get_policy_notice('cancellation_policy_notice', '70% refund if cancelled before the booking date. No refund on the day of or after the event.')) ?>
                        </div>
                    </div>
                </div>
            </div>
