...
<div class="page-header">
    <div class="d-flex justify-content-between align-items-center">
        ...
        <a href="<?= base_url('inventory/items') ?>" class="btn btn-outline-dark">
                ...
                <div class="tab-pane fade" id="pricing">
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" step="0.01" class="form-control" id="wholesale_moq" name="wholesale_moq" value="0">
                        </div>

                        <div class="col-md-6 pt-4">
                            <div class="form-check form-switch mt-2">
                                <input class="form-check-input" type="checkbox" name="is_wholesale_enabled" id="isWholesale">
