...
<div class="row g-3 mb-4">
    <div class="col-md-3">
        <div class="card">
            <div class="card-body">
                <h6 class="text-muted mb-2">Compliance Score</h6>
                <h2 class="mb-0"><?= $compliance_score ?? 100 ?>%</h2>
            </div>
        </div>
    </div>
    <div class="col-md-3">
        <div class="card">
            <div class="card-body">
                <h6 class="text-muted mb-2">Tax Payable</h6>
                <h2 class="mb-0"><?= format_currency(($total_vat_payable ?? 0) + ($total_wht_payable ?? 0) + ($total_cit_payable ?? 0) + ($total_paye_payable ?? 0)) ?></h2>
            </div>
        </div>
    </div>
    <div class="col-md-3">
        <div class="card">
            <div class="card-body">
                ...
                <h2 class="mb-0"><?= count($upcoming_deadlines ?? []) ?></h2>
            </div>
        </div>
    </div>
    <div class="col-md-3">
        <div class="card">
            <div class="card-body">
                ...
                <h2 class="mb-0 text-danger"><?= count($overdue_deadlines ?? []) ?></h2>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="col-md-4">
        <div class="card">
            <div class="card-body">
                ...
                <a href="<?= base_url('tax/vat') ?>" class="btn btn-dark">Go to VAT</a>
            </div>
        </div>
    </div>
    <div class="col-md-4">
        <div class="card">
            <div class="card-body">
                ...
                <a href="<?= base_url('tax/wht') ?>" class="btn btn-dark">Go to WHT</a>
            </div>
        </div>
    </div>
    <div class="col-md-4">
        <div class="card">
            <div class="card-body">
                ...
                <a href="<?= base_url('tax/cit') ?>" class="btn btn-dark">Go to CIT</a>
            </div>
        </div>
    </div>
</div>
