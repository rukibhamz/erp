...
<div class="card shadow-sm mb-4 list-filters-card">
    <div class="card-body">
        <form method="GET" action="<?= base_url('utilities/tariffs') ?>" class="list-filters-form">
            ...
            <div class="col-md-4">
                ...
                <?php render_list_filter_submit_buttons(base_url('utilities/tariffs')); ?>
            </div>
        </form>
    </div>
</div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group btn-group-sm">
                                        <a href="<?= base_url('utilities/tariffs/view/' . $tariff['id']) ?>" class="btn btn-primary" title="View">
                                            <i class="bi bi-eye"></i>
                                        </a>
                                        <a href="<?= base_url('utilities/tariffs/edit/' . $tariff['id']) ?>" class="btn btn-primary" title="Edit">
