...
<div class="row">
    <div class="col-lg-12">
        <div class="card shadow-sm">
            ...
            <div class="card-body">
                <form method="POST" action="<?= base_url('ledger/create') ?>" id="journalForm">
                    <?php echo csrf_field(); ?>
                        ...
                        <div class="journal-line mb-3 p-3 border rounded">
                            <div class="row g-3">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="text" class="form-control" name="lines[0][description]" placeholder="Line description">
                                </div>
                                <div class="col-md-2">
...
function addLine() {
    ...
    newLine.innerHTML = `
        <div class="row g-3">
            ...
            <div class="col-md-3">
                <label class="form-label">Description</label>
                <input type="text" class="form-control" name="lines[${lineCount}][description]" placeholder="Line description">
            </div>
            <div class="col-md-2">
                <label class="form-label">Debit</label>
