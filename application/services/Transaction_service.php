    ...
    public function postJournalEntry($data) {
        ...
        try {
            ...
            if ($data['auto_post'] ?? false) {
                ...
                // Invalidate cached computed balances for affected accounts.
                // NOTE: journalModel->post() already updates account balances.
                // Avoid double-updating account.balance here.
                foreach ($data['entries'] as $entry) {
