    ...
    public function create($propertyId = null) {
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            $data = [
                ...
                'video_url' => !empty($_POST['video_url']) ? sanitize_input($_POST['video_url']) : null,
                'detailed_description' => !empty($_POST['detailed_description']) ? $_POST['detailed_description'] : null,
