...
<div class="page-header">
    <div class="d-flex justify-content-between align-items-center">
        <h1 class="page-title mb-0">Create Utility Provider</h1>
...
<div class="card">
    <div class="card-body">
        <form action="<?= base_url('utilities/providers/create') ?>" method="POST">
            <div class="row g-3">
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" id="service_areas" name="service_areas" placeholder="Comma-separated list">
                </div>
            ...
            <div class="mt-4 d-flex justify-content-end gap-2">
                <a href="<?= base_url('utilities/providers') ?>" class="btn btn-outline-secondary">Cancel</a>
