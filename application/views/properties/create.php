...
<div class="page-header">
    <div class="d-flex justify-content-between align-items-center">
        <h1 class="page-title mb-0">Create Property</h1>
...
<div class="card">
    <div class="card-body">
        <form action="<?= base_url('properties/create') ?>" method="POST">
            <div class="row g-3">
                <div class="col-md-6">
                    <label for="property_code" class="form-label">Property Code <span class="text-danger">*</span></label>
                ...
                <div class="col-md-6">
                    ...
                    <select class="form-select" id="property_type" name="property_type" required>
                        <option value="multi_purpose">Multi-purpose Complex</option>
                ...
                <div class="col-md-3">
                    ...
                    <input type="number" step="0.01" class="form-control" id="built_area" name="built_area">
                </div>
                ...
                <div class="col-md-3">
                    ...
                    <input type="number" class="form-control" id="year_acquired" name="year_acquired" min="1900" max="<?= date('Y') ?>">
                </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="input-group">
                        <input type="number" step="0.00000001" class="form-control" id="gps_latitude" name="gps_latitude" placeholder="Latitude">
                        <input type="number" step="0.00000001" class="form-control" id="gps_longitude" name="gps_longitude" placeholder="Longitude">
                    </div>
                </div>
            </div>
