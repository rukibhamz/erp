...
<div class="page-header">
    <div class="d-flex justify-content-between align-items-center">
        <h1 class="page-title mb-0">Edit Currency</h1>
        <a href="<?= base_url('currencies') ?>" class="btn btn-outline-dark">
        ...
        <div class="card-body">
            <form method="POST">
                ...
                <div class="d-flex justify-content-end gap-2">
                    <a href="<?= base_url('currencies') ?>" class="btn btn-outline-dark">Cancel</a>
