        ...
        <form action="<?= base_url('spaces/edit/' . $space['id']) ?>" method="POST" id="spaceForm" enctype="multipart/form-data">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-check mt-2">
                        <input class="form-check-input" type="checkbox" id="is_featured" name="is_featured" value="1" <?= !empty($space['is_featured']) ? 'checked' : '' ?>>
                ...
                <div class="col-12">
                    ...
                    <textarea class="form-control" id="description" name="description" rows="2" placeholder="Brief summary for space listings"><?= htmlspecialchars($space['description'] ?? '') ?></textarea>
                </div>

                <div class="col-12">
                    <label for="video_url" class="form-label">Video URL</label>
                    <input type="url" class="form-control" id="video_url" name="video_url" value="<?= htmlspecialchars($space['video_url'] ?? '') ?>" placeholder="YouTube or Vimeo URL">
                ...
                <div class="col-12">
                    ...
                    <textarea class="form-control" id="detailed_description" name="detailed_description" rows="5" placeholder="Comprehensive information about the space"><?= htmlspecialchars($space['detailed_description'] ?? '') ?></textarea>
                </div>
