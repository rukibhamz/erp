                ...
                <div class="row">
                    ...
                    ?>
                        <div class="col-md-3 mb-3">
                            ...
                            <input type="number" name="<?= $month['field'] ?>" class="form-control" step="0.01" 
                                   value="<?= $budget[$month['field']] ?? 0 ?>" onchange="calculateTotal()">
                        </div>
                    <?php endforeach; ?>
                </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6 text-end">
                                <h5 id="totalBudget"><?= number_format($budget['total'] ?? 0, 2) ?></h5>
                            </div>
                        </div>
                    </div>
                </div>
