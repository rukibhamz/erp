        ...
        <form method="GET" class="row g-3 align-items-end">
            ...
            <div class="col-md-6">
                <?php if ($selected_space): ?>
                    <a href="<?= base_url('space-bookings/create/' . $selected_space['id']) ?>" class="btn btn-primary">
    ...
    <div class="card shadow-sm">
        ...
        <div class="card-body">
            <div id="calendar-container">
                <p class="text-muted">Calendar view coming soon. For now, please use the booking form to check availability.</p>
                <!-- Calendar will be implemented with a JavaScript library like FullCalendar -->
            </div>
...
<?php else: ?>
    <div class="card shadow-sm">
        <div class="card-body text-center py-5">
            ...
            <p class="text-muted">Please select a space from the dropdown above to view its booking calendar.</p>
        </div>
    </div>
<?php endif; ?>
