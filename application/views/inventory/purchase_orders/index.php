...
<div class="card shadow-sm mb-4 list-filters-card">
    <div class="card-body">
        <form method="GET" action="<?= base_url('inventory/purchase-orders') ?>" class="list-filters-form">
            ...
            <div class="col-md-4">
                ...
                <?php render_list_filter_submit_buttons(base_url('inventory/purchase-orders')); ?>
            </div>
        </form>
    </div>
</div>
